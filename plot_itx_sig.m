...
mean_decoding(cond,:,s) =filter(1/3*ones(1,3), 1, diag(DECODING_RESULTS.ZERO_ONE_LOSS_RESULTS.mean_decoding_results));
else
    subj{s}
...
plot([-225+round(bin_width/2) 1000-bin_width], [1/52, 1/52], 'k')%1/60
xlim([-200 1000])
